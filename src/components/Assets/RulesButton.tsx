...
const RulesButton: React.FC<PropsT> = ({ onTap }) => {
  return (
    <motion.button
      ...
      onTap={onTap}
      className="w-11/12 flex flex-row gap-2.5 py-3.5 items-center justify-center rounded text-primary-700 font-vazir font-normal text-sm bg-secondary-500 md:hidden"
    >
