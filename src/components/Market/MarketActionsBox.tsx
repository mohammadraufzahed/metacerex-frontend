...
const MarketAction: React.FC<PropsT> = ({ children }) => {
  ...
  return (
    <div className="w-full flex-auto min-h-full flex flex-col items-center gap-6 bg-neutral-50 px-2 py-4 rounded-2xl lg:max-w-[440px] lg:min-h-full lg:max-h-[900px] mx-auto md:mx-0 md:py-6 md:px-5">
