...
const MarketAction: React.FC<PropsT> = ({ children }) => {
  ...
  return (
    <div className="flex-auto w-full flex flex-col items-center gap-4 bg-neutral-50 dark:bg-neutral-900 px-2 py-4 rounded-2xl lg:max-w-[440px] lg:h-[90vh] lg:overflow-y-scroll scrollbar-vertical mx-auto md:mx-0 md:py-6 md:px-5">
