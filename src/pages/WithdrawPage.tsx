  ...
  return (
    <div className="flex-auto h-max w-full py-2 px-4 flex flex-row gap-4">
      ...
      <RulesBox show={ruleOpen} onClose={() => setRuleOpen(false)}>
        {currentForm == "toman" ? (
          <div className="flex flex-col w-full gap-12 rounded-lg bg-neutral-50 py-10 md:px-3">
            ...
            <div className="w-full bg-neutral-50 py-10 px-2 rounded-2xl flex flex-col gap-10 xl:flex-row items-center md:px-14 md:py-16">
              <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <span className="font-vazir font-normal text-sm md:text-base">
                    2. با توجه به آدرس و شبکه ی موجود در ولت مقصد، شبکه ی انتقال
                    را انتخاب نمایید.
                  </span>
                  <span className="font-vazir font-normal text-sm md:text-base">
                    3. تعداد رمزارز مورد نظر را در قسمت «مقدار» وارد کنید. در
                    نهایت ثبت برداشت را بزنید و منتظر بمانید تا برداشت شما تکمیل
                    شود.
                  </span>
                </div>
              </div>
